...
if __name__ == "__main__":
    ...
    for opt, arg in opts:
        ...
        if opt in ("--methylation_file"):
            ...
            methylation_file = '/input_data/README_glass_methylation.txt'
        # GLASS clinical file
        ...
        if opt in ("--methylation_by_gene_file"):
            ...
            methylation_by_gene_file = '/intermediate_files/glass_methylation_genes.tsv'
        # results differential methylation file    
        if opt in ("--dgea_file"):
            dgea_file = str(arg)
            dgea_file = '/intermediate_files/glass_dgea_methylation.tsv'
