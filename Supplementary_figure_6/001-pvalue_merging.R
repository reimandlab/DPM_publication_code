# merge p-values using Brown's method and DPM
...
opt = list(
    gene_expression_file = '~/input_data/intermediate_files/glass_dgea.tsv',
    protein_expression_file = '~/input_data/intermediate_files/validation_proteomics_dgea.tsv',
    methylation_file = '~/input_data/intermediate_files/glass_dgea_methylation.tsv',
    combined_pval_file = '~/input_data/glass_pvals.tsv',
    combined_fc_file = '~/input_data/glass_fcs.tsv',
    merged_pvalues_file = '~/input_data/merged_pvalues.tsv'
)
