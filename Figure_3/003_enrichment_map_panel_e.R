#### Figure 3E
### Enrichment map of pathways and processes from directional and non-directional analyses (FWER < 0.05)
...
# save results
save(ap_background, df_oe_kd,res_brown,res_dpm, file = "panelE_Rdata.Rdata")
